...
const ServiceSelector = ({ catalog, selectedServices = [], onSelect }) => {
                    ...
                    {catalog?.map((cat) => {
                        ...
                        return (
                            <button
                                ...
                                className="flex flex-col items-center justify-center p-4 bg-zinc-800/50 border border-zinc-700/50 rounded-2xl hover:border-zinc-500 hover:bg-zinc-800 transition-all active:scale-95 group"
                            >
    ...
    return (
        <div className="bg-zinc-900 border border-zinc-800 rounded-[2rem] p-6 w-full max-w-sm animate-in fade-in slide-in-from-bottom-4 duration-500">
            ...
            <button
                onClick={() => setStep('categories')}
                className="w-full h-12 bg-white text-black rounded-full font-black text-sm active:scale-95 transition-all"
            >
