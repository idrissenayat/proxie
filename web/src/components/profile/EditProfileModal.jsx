...
import { X, Camera, Save, User, Briefcase, Phone, Book } from 'lucide-react';
...
const EditProfileModal = ({ provider, onClose, onSave }) => {
    ...
    return (
        <div className="fixed inset-0 z-[100] flex items-end sm:items-center justify-center bg-black/60 backdrop-blur-md">
            <div className="bg-zinc-950 border-t sm:border border-white/10 rounded-t-[3rem] sm:rounded-[3rem] w-full max-w-lg overflow-hidden animate-in slide-in-from-bottom duration-500 shadow-2xl">
                ...
                <form onSubmit={handleSubmit} className="p-8 space-y-6 max-h-[70vh] overflow-y-auto">
                    ...
                    <button
                        type="submit"
                        className="w-full h-16 bg-white text-black rounded-2xl font-black text-lg flex items-center justify-center gap-3 shadow-2xl shadow-white/10 mt-8"
                    >
