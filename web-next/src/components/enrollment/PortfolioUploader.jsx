            ...
            <div className="grid grid-cols-3 gap-3 mb-6">
                {photos.map((photo) => (
                    <div key={photo.id} className="relative aspect-square">
                        ...
                        <button
                            ...
                            className="absolute -top-1 -right-1 w-5 h-5 bg-white text-black rounded-full flex items-center justify-center shadow-lg border border-black cursor-pointer"
                        >
                ...
                {photos.length < 9 && (
                    <button
                        ...
                        className="aspect-square bg-zinc-800/50 border border-dashed border-zinc-700 rounded-xl flex flex-col items-center justify-center group hover:border-zinc-500 transition-all active:scale-95 cursor-pointer"
                    >
