...
import { Plus, Trash2, Edit3, DollarSign, Clock, X, CheckCircle2 } from 'lucide-react';
                    ...
                    <div key={service.id} className="bg-zinc-900 border border-zinc-800 rounded-2xl p-4 flex items-center justify-between group">
                        ...
                        <div className="flex gap-2">
                            <button
                                ...
                                className="w-9 h-9 bg-zinc-800/50 rounded-xl flex items-center justify-center text-zinc-500 hover:text-red-400 hover:bg-red-500/10 transition-all cursor-pointer"
                            >
                                <Trash2 size={16} />
                            </button>
                        </div>
